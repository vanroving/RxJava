package com.guoxin.githubdemo.image;
...
public class ImagPagerUtil {
    ...
    public ImagPagerUtil(Context context, List<String> mPicList) {
    ...
    private void init() {
        ...
        RelativeLayout contentView = (RelativeLayout) View.inflate(mContext, R.layout.view_dialogpager_img, null);
